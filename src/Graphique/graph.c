...
int main(void) {
    ...
    Image background = LoadImage("/Users/thomas/CLionProjects/Pendu/pendu.png");
    backgroundTexture = LoadTextureFromImage(background);
    UnloadImage(background);

    // Chargement de l'image de fond de la page CREDITS
    Image creditsBackground = LoadImage("/Users/thomas/CLionProjects/Pendu/credit.png");
    ...
    Image rulesBackground = LoadImage("/Users/thomas/CLionProjects/Pendu/regles.png");
    ...
    Image difficultyBackground = LoadImage("/Users/thomas/CLionProjects/Pendu/niveaux.png");
